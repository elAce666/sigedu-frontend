    ...
    <div className="nosotros">
      <div className="nosotros__container">
        ...
        <p className="text-suave nosotros__intro">
          ...
          la comunicacion con las familias y la gestion diaria de su comunidad educativa.
        </p>
        ...
        <div className="nosotros__grid">
          <div className="nosotros__card">
            ...
            <p>
              El colegio avanza hacia una gestion mas ordenada y accesible, manteniendo siempre el
              foco en la formacion integral de sus estudiantes.
            </p>
          </div>
          <div className="nosotros__card">
            <RiGroupLine />
            ...
            <p>
              ...
              escolar, con acceso oportuno a la informacion relevante.
            </p>
          </div>
          <div className="nosotros__card">
            <RiAwardLine />
            ...
            <p>
              Acompanar el trabajo cotidiano del colegio con herramientas claras, confiables y
