...
export default function MiPerfil() {
  ...
  return (
    <div className="page-content">
      <PageHeader title="Mi perfil" subtitle="Información de tu cuenta en SIGEDU" />
      ...
      <div className="perfil-card card">
        ...
        <div className="perfil-card__info">
          ...
          <ul className="perfil-card__detalles">
            ...
            <li><RiShieldUserLine /> Acceso autenticado vía SIGEDU (JWT)</li>
          </ul>
        </div>
      </div>
      ...
      <div className="card perfil-nota">
        <p className="text-suave">
          Para actualizar tus datos personales, contraseña o información de contacto, comunícate
          con el área administrativa del Colegio Bernardo O'Higgins a través de Mensajería.
        </p>
      </div>
    </div>
  )
